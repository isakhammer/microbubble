...
RUN apt-get install -yq build-essential autoconf automake cmake libtool gfortran python
RUN apt-get install -yq libboost-all-dev zlib1g-dev
RUN apt-get install -yq openmpi-bin openmpi-common libopenmpi-dev
...
RUN git clone --branch master https://github.com/isakhammer/candi.git
